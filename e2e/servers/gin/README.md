...
import (
    ...
    svm "github.com/coinbase/x402/go/v2/mechanisms/svm/exact/server"
...
- `github.com/coinbase/x402/go/v2/http` - HTTP integration
- `github.com/coinbase/x402/go/v2/http/gin` - Gin middleware
- `github.com/coinbase/x402/go/v2/mechanisms/evm` - EVM server
- `github.com/coinbase/x402/go/v2/mechanisms/svm` - SVM server
- `github.com/coinbase/x402/go/v2/extensions/bazaar` - Discovery extension
