...
export const minikitConfig = {
  ...
  miniapp: {
    ...
    description:
      "A Farcaster Mini App with payment protected endpoints",
    ...
    splashBackgroundColor:
      process.env.NEXT_PUBLIC_SPLASH_BACKGROUND_COLOR || "#3b82f6",
    homeUrl: ROOT_URL,
    webhookUrl: `${ROOT_URL}/api/webhook`,
    primaryCategory: "developer-tools" as const,
    tags: ["payments"],
    heroImageUrl:
      process.env.NEXT_PUBLIC_APP_HERO_IMAGE || `${ROOT_URL}/hero.png`,
