 ...
 * using the high-level CreateX402MCPClient factory function with REAL MCP SDK.
 *
...
/**
 * Demonstrates the simple API using CreateX402MCPClient factory with REAL MCP SDK.
 */
func runSimple() error {
	...
	x402Mcp := mcp.CreateX402MCPClient(
		adapter,
