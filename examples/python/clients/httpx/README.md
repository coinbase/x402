...
This example demonstrates how to use the x402 v2 SDK with httpx (async) to make requests to 402-protected endpoints.
...
4. **Make request** - The `x402HttpxClient` automatically handles 402 responses:
