...
contract X402UptoPermit2ProxyForkTest is Test {
    ...
    function test_fork_settleWithRealPermit2() public onlyFork {
        ...
        x402UptoPermit2Proxy.Witness memory witness =
            x402UptoPermit2Proxy.Witness({to: recipient, validAfter: t - 60, validBefore: t + 3600, extra: ""});
    ...
    function test_fork_rejectsExpiredDeadline() public onlyFork {
        ...
        x402UptoPermit2Proxy.Witness memory witness =
            x402UptoPermit2Proxy.Witness({to: recipient, validAfter: t - 120, validBefore: t + 3600, extra: ""});
