...
// This declares the module "@b3dotfun/anyspend-x402/facilitator" to have a simplified verify function signature
// that doesn't cause deep type instantiation issues
declare module "@b3dotfun/anyspend-x402/facilitator" {
  import {
    PaymentPayload,
    PaymentRequirements,
    VerifyResponse,
    SettleResponse,
  } from "@b3dotfun/anyspend-x402/types/verify";
