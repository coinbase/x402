...
import { RetryExecutor, RetryExhaustedError, CircuitBreakerOpenError, RetryTimeoutError } from '../src/executor';
...
describe('RetryExecutor', () => {
  ...
  describe('execute()', () => {
    ...
    it('should not retry on non-retryable errors', async () => {
      ...
      await expect(
        executor.execute(operation, defaultRetryPolicy)
    ...
    it('should throw RetryExhaustedError after maxAttempts', async () => {
      ...
      await expect(
        executor.execute(operation, policy)
