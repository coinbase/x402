...
Add the RPC proxy endpoint to your Hono app:

```typescript
import { Hono } from "hono";
import { solanaRpcProxy } from "x402-hono/endpoints";
...
2. **API route not found**
   ...
   - Verify the import: `import { solanaRpcProxy } from "x402-hono/endpoints"`
