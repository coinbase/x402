...
import (
    ...
    "github.com/coinbase/x402/go/v2/mechanisms/solana/v1"
)
...
**Before (V1)**:
```go
import "github.com/coinbase/x402/go/v2/mechanisms/solana/v1"
...
**After (V2)**:
```go
import "github.com/coinbase/x402/go/v2/mechanisms/solana"
