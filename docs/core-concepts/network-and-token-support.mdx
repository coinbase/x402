...
* [Quickstart for Sellers](/docs/quickstart/sellers) — Start accepting payments on supported networks
* [Core Concepts](/docs/core-concepts) — Learn how x402 works under the hood
* [Facilitator](/docs/core-concepts/facilitator) — Understand the role of facilitators
* [MCP Server](/docs/advanced/mcp-server) — Set up AI agents to use x402 payments
