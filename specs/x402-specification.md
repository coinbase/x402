...
This specification defines the core x402 protocol for transport-agnostic payments. It covers:
...
There shall be seperated specifications for transport-specific, scheme-specific, and implementation-specific use cases.
...
The specific mechanisms for signaling payment requirements and transmitting payment data are defined by individual transport specifications.
...
This section defines the core JSON schemas used in the x402 protocol. These schemas are referenced by transport and scheme implementations.
...
| ------- | --------- | --------------------------- | ------------------------- |
| v0.2    | 2025-9-25 | Transport-agnostic redesign | Ethan Niser               |
