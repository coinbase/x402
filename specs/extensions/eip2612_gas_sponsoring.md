...
3.  **Simulate** `x402Permit2Proxy.settleWith2612`

## Settlement Logic

The Settlement is performed by calling the [`x402Permit2Proxy.settleWith2612`](../schemes/exact/scheme_exact_evm.md#reference-implementation-x402permit2proxy).
